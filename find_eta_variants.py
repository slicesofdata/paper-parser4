...
Helps identify OCR errors where the 'p' in \\eta_p^2 (partial eta squared)
was misread as a different letter.
"""
...
# Match: \eta _ { anything } ^ { 2 }  with flexible spacing
...
def main() -> None:
    ...
    for md in sorted(INPUT_DIR.rglob("*.md")):
        ...
        # count unique variants in this file
